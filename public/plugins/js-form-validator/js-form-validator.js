	...
	Protected.prototype = {
		...
		messages: {
		    ...
		    es: {
		        ...
		        notzero: {
		            empty: 'Por favor haz una selección',
		            incorrect: 'Valor incorrecto'
		        },
		        integer: {
		            empty: 'Introduzca un valor entero',
		            incorrect: 'Valor entero incorrecto'
		        },
		        float: {
		            empty: 'Ingrese un número flotante',
		            incorrect: 'Flotador incorrecto'
		        },
		        min: {
		            empty: 'Entrar mas',
		            incorrect: 'Entrar mas'
		        },
		        max: {
		            empty: 'Ingrese menos',
		        ...
		        between: {
		            empty: 'Ingrese el entre {0}-{1}',
		            incorrect: 'Ingrese el entre {0}-{1}'
		        },
		        name: {
		            empty: 'Por favor, escriba su nombre',
		        ...
		        phone: {
		            ...
		            incorrect: 'Numero de telefono incorrecto'
		        },
		        email: {
		            empty: 'Por favor, introduzca su dirección de correo electrónico',
		            incorrect: 'Dirección de E-Mail incorrecta'
		        },
		        length: {
		            empty: 'Por favor, ingrese un mínimo de {0} caracteres y un máximo de {1}',
		            incorrect: 'Incorrecto. ingrese un mínimo de {0} caracteres y un máximo de {1}'
		        },
		        minlength: {
		            empty: 'Por favor, ingrese al menos {0} caracteres',
		            incorrect: 'Has ingresado menos de {0} caracteres'
		        },
		        maxlength: {
		            empty: 'Por favor, ingrese al máximo {0} caracteres',
		            incorrect: 'Has entrado más de {0} caracteres'
		        },
		        maxfilesize: {
		            empty: 'El tamaño de uno o más archivos seleccionados más grandes que {0} {1}',
		            incorrect: 'El tamaño de uno o más archivos seleccionados más grandes que {0} {1}'
		        },
		        fileextension: {
			...
			var self = this,
				...
				insertNodeError = function (refNode, errorObj) {
					...
					if (self.settings.showErrors) {
						...
						errorDiv.setAttribute('title', errorObj.errorText);
						errorDiv.setAttribute('data-toggle', 'tooltip');
						errorDiv.setAttribute('data-placement', 'bottom');
