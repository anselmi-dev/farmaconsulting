...
class ProvincesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Province::create(['code' => 7,	'name' => 'Baleares/Illes Balears']);
        ...
        Province::create(['code' => 17,	'name' => 'Gerona/Girona']);
        Province::create(['code' => 18,	'name' => 'Granada']);
        Province::create(['code' => 19,	'name' => 'Guadalajara']);
        Province::create(['code' => 20, 'name' => 'Guipúzcoa/Gipuzkoa']);
        ...
        Province::create(['code' => 25,	'name' => 'Lérida/Lleida']);
        ...
        Province::create(['code' => 32,	'name' => 'Orense/Ourense']);
