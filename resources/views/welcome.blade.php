...
@section('content')
    <div id="loadingMessage">
        {{-- Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illo ut commodi accusantium velit, perferendis ducimus sapiente soluta, corrupti quas dignissimos consequuntur. Tenetur quis praesentium est corporis totam cum nostrum veritatis. --}}
    </div>
    <div class="content-qr min-h-full flex flex-wrap items-center justify-center">
