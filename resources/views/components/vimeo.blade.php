        ...
        <div id="div-screen-{{ $key }}" class="div-screen w-full mx-auto">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 pb-10">
                <div class="relative" style="padding:56.25% 0 0 0;">
                    <div id="playbtn-{{ $key }}" class="absolute flex items-center justify-center w-full h-full cursor-pointer top-0 left-0 m-auto" style="z-index: 10">
                        <img id="playbtn-icon-{{ $key }}" src="{{ asset('images/pay.png') }}" class="max-w-full max-h-full w-20">
                    </div>
                    <div id="fullscreenbtn-{{ $key }}" class="absolute flex items-center justify-center cursor-pointer bottom-2 left-2 m-auto bg-gray-100 rounded p-1" style="z-index: 11">
