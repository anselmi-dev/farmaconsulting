<nav class="nav">
    ...
    <button class="nav__profile" data-micromodal-trigger="modal-account">
...
<div class="modal modal--full micromodal-slide" id="modal-account" aria-hidden="true">
    <div class="modal__overlay" tabindex="-1" data-micromodal-close>
        <div class="modal__container bg-gray-200" role="dialog" aria-modal="true" aria-labelledby="modal-account-title">
            ...
            <div data-micromodal-close style="width: 25.414px" class="pointer">
            ...
            <div class="modal__content" id="modal-account-content">
                <ul>
                    ...
                    <li x-data="{ expanded: false }">
                        ...
                        <div x-show="expanded" x-collapse>
                            <div class="options__item">
                                <div class="options__catalog-number">1234</div>
            ...
            <div class="modal__footer">
                <div class="text-center mt-10">
                    ...
                    <div class="margin-bottom--xlarge">
                        <img src="{{ asset('img/logos/logo-secondary-gray.png') }}"
